...
import { Grid, Typography, Avatar, Button, Divider,Pagination, PaginationItem } from "@mui/material";
...
export default function BlogItemUser() {
  ...
  return (
    <Grid container rowSpacing={4} mt={2} height={"100%"} width={"100%"} xs={8} sx={{ml:3}}>
      {currentBlogs?.length === 0 ? (
        <Grid item xs={12}>
          <Typography variant="body1" sx={{mt:6,ml:30,textAlign:'center',color:'#ff5e00'}}>
